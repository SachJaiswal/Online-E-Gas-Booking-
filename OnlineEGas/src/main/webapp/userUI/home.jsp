...
<body>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/orderstatus.jsp">Home</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/ordergas.jsp">Book Gas
								Cylinder</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/orderhistory.jsp">Booking
								History</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/orderstatus.jsp">Order
								Status</a></li>
					</ul>
	...
	<div class="container" style="padding: 20px;">
		...
		<div id="orderstatus" class="form-container">
			<h2>
				<i class="fas fa-info-circle"></i> Order Status
			</h2>
			<!-- Add content for Order Status section -->
		</div>
		...
		<div id="ordergas" class="form-container hidden">
			<h2>
				<i class="fas fa-book"></i> Book Gas Cylinder
			</h2>
			<form action="bookGas" method="post">
